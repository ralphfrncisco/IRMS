            ...
            <div key={item.id} className="sm:space-y-1 flex-shrink-0 relative group">
              {hasSubmenu ? (
                <>
                  ...
                  {isOpen && (
                    <div className="sm:hidden absolute bottom-15 left-12/4 -translate-x-1/2 dark:bg-slate-900 bg-white  rounded-xl shadow-2xl border border-slate-300 dark:border-slate-700 overflow-hidden p-1 z-50">
