...
function TableSection() {
    ...
    return (
        ...
        <div className={`pb-3 rounded-2xl border transition-all duration-300 overflow-hidden ${
            darkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'
        }`}>
            <div className={`p-4 border-b ${darkMode ? 'border-slate-800' : 'border-slate-100'}`}>
                <div className="flex items-center justify-between">
                    <div>
                    <h3 className={`text-lg font-bold ${darkMode ? 'text-white' : 'text-slate-800'}`}>Recent Sales</h3>
