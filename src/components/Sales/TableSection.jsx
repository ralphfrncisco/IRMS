                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-between w-full py-2">
                        ...
                        <div className="flex items-center gap-2 relative" ref={filterRef}>
                            ...
                            {showFilters && (
                                <div className="absolute top-full right-0 lg:right-37 mt-2 w-60 p-4 bg-white dark:bg-[#111] border border-slate-200 dark:border-white/10 rounded-xl shadow-xl z-50 space-y-3 animate-in fade-in zoom-in duration-200">
                ...
                <table className="w-full text-left border-separate border-spacing-0">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-white/10">
                        {loading ? (
                            ...
                            <tr key={order.order_id} className="text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
