    ...
    return (
        <div className="fixed inset-0 bg-black/60 z-50 flex py-2 items-center justify-center overflow-y-auto">
            ...
            >
                ...
                <form id="edit-product-form" onSubmit={handleSubmit} className="flex flex-col h-full overflow-y-auto custom-scrollbar">
                    ...
                    <div className="pt-5 border-t border-slate-200 dark:border-white/10 flex justify-end gap-3 flex-shrink-0">
                        ...
                        <button type="submit" form = "edit-product-form" disabled={loading} className="px-7 py-2 text-sm font-bold text-white bg-blue-600 rounded-lg hover:bg-blue-700 shadow-md active:scale-95 transition-all disabled:opacity-50 flex items-center justify-center min-w-[140px]">
