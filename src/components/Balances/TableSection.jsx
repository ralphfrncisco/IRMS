    ...
    return (
        <div className="rounded-2xl border bg-white border-slate-200 dark:bg-slate-900 dark:border-slate-800 transition-all duration-300 mb-25 pb-5 md:pb-0">
            ...
            <div className="overflow-x-auto max-h-[600px] p-2">
                <table className= "w-full table-fixed text-left border-collapse border-spacing-y-1">
                    <thead>
                        <tr className="bg-slate-50/50 dark:bg-slate-800/50">
                            ...
                            {visibleColumns['PURCHASED ITEMS'] && <th className="w-[450px] p-4 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Purchased Items</th>}
                                ...
                                <tr key={order.db_id} className="text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors group">
                                    ...
                                    {visibleColumns['PURCHASED ITEMS'] && (
                                        <td className="p-4 text-sm">
                                            ...
                                            <div className="w-[450px] truncate font-medium text-slate-600 dark:text-slate-400" title={order.purchased_items}>
