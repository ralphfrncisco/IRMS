            ...
            <div className="p-4 border-b border-slate-100 dark:border-slate-800 gap-4 w-full md:w-auto space-y-2">
                <div className="flex items-center justify-between w-full py-2">
                    ...
                    <div className="flex items-center gap-2 relative" ref={filterRef}>
                        ...
                        {showFilters && (
                            <div className="absolute top-full right-0 mt-2 w-55 p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl z-50 space-y-3 animate-in fade-in zoom-in duration-200">
